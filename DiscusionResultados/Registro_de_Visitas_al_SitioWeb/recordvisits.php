    ...
    <body>
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                date_default_timezone_set('America/El_Salvador');//para que date() obtenga la hora/fecha segun nuestra region
                $ip_visitante = $_SERVER['REMOTE_ADDR'];
                $nombre_script = $_SERVER['PHP_SELF'];
                $fecha_hora = date("Y-m-d H:i:s");
 
                //Obtener los datos del formulario y asignarlos en las propiedades
                //de la clase guestBook.class.php
                $entry = new guestBook();
                ...
                $entry->setDireccionIp($ip_visitante);
                $entry->setNombreScript($nombre_script);
                $entry->setFechaHora($fecha_hora);
        ...
        <section id='container'><h1>Esta página web registra tu direccion IP, fecha y hora de visita</h1></section>
            <!-- <span class="chyron"><em>
                <a href="http://www.hongkiat.com/blog/">&laquo; back to the site</a>
            </em></span> -->
                ...
                <div id="wrapping" class="clearfix">
                    <section id="aligned">
                        <input type="text" name="yourname" id="yourname" placeholder="(Tu nombre)" autocomplete="off" maxlength="40" tabindex="1" class="txtinput" 
                            ...
                            oninvalid="this.setCustomValidity('Por favor, ingresa tu nombre, este campo no puede estar vacío.')"/>
                        <input type="text" name="youraddress" id="youraddress" placeholder="(Tu dirección)" autocomplete="off" maxlength="60" tabindex="2" class="txtinput" 
                            required oninput="this.setCustomValidity('')" 
                            oninvalid="this.setCustomValidity('Por favor, ingresa tu direccion, este campo no puede estar vacío.')"/>
                    ...
                    <section id="aside" class="clearfix">
                        <section id="recipientcase">
                            ...
                            <img src="jscalendar/image.png" id="imgcalendar" style="cursor: pointer; border: 1px solid red; display: inline-block;" title="Ingrese la fecha" onmouseover="this.style.background='red';" onmouseout="this.style.background=''" />
                            <br />
