...
<div class="max-w-xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-slate-100">
    ...
    <form action="<?php echo e(route('appointments.update', $appointment->id)); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?> <div>
            ...
            <select name="specialty_id" class="w-full p-2.5 border rounded-lg bg-white shadow-sm text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none border-slate-200">
                <?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($specialty->id); ?>" <?php echo e(old('specialty_id', $appointment->specialty_id) == $specialty->id ? 'selected' : ''); ?>>
        ...
        <div>
            ...
            <select name="doctor_id" class="w-full p-2.5 border rounded-lg bg-white shadow-sm text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none border-slate-200">
                <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($doctor->id); ?>" <?php echo e(old('doctor_id', $appointment->doctor_id) == $doctor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="appointment_date" value="<?php echo e(old('appointment_date', $appointment->appointment_date)); ?>" class="w-full p-2.5 border rounded-lg shadow-sm text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none border-slate-200">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="time" name="appointment_time" value="<?php echo e(old('appointment_time', \Carbon\Carbon::parse($appointment->appointment_time)->format('H:i'))); ?>" class="w-full p-2.5 border rounded-lg shadow-sm text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none border-slate-200">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <textarea name="symptoms" rows="3" class="w-full p-2.5 border rounded-lg shadow-sm text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none border-slate-200"><?php echo e(old('symptoms', $appointment->symptoms)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Users\Josue\UDB\2026\DSS404\Laboratorio\Desafio 3\control_citas_medica\resources\views/appointments/edit.blade.php ENDPATH**/ ?>